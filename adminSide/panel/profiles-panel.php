    ...
    <div class="row">
        <div class="col-md-6 order-md-1" style="margin-top: 6rem; margin-left: 15rem;">
            ...
            <form method="get" action="#">
                <div class="row">
                    <div class="col-md-8">
                        <input required type="text" id="member_id" style="width:100%" name="member_id" class="form-control" placeholder="Enter Member ID">
                    </div>
                    <div class="col-md-4">
        ...
        <div class="col-md-6 order-md-2" style="margin-top: 3rem; margin-left: 12rem">
            <div class="container-fluid pt-5">
                <h3 style="text-align: center">Top 5 Favourites - (All Time)</h3>
