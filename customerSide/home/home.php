...
<body>
 ...
 <section id="header" style="background: black;">
  <div class="header container" style="background: #0000;">
    <div class="nav-bar" style="background: #0000;">
      <div class="brand" style="background: transparent;">
        <a class="nav-link" href="../home/home.php#hero">
          <h1 class="text-center" style="font-family: Copperplate; color: white; font-size: 4rem; font-weight: bold;">DINEHUB</h1>
          <span class="sr-only" style="background: #fff;"></span>
       


          <!-- <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> DINEHUB</h1><span class="sr-only"></span> -->
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
          ...
          <div class="navbar-container" style="background: transparent;">
...
<section id="hero" style="position: relative; background-size: cover; background-position: center; height: 100vh; display: flex; justify-content: center; align-items: center; text-align: center; color: #ffffff;">
    <div id="container" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); z-index: 1;"></div>
    <iframe src="https://www.google.com/maps/embed?pb=!4v1707730044766!6m8!1m7!1sCAoSLEFGMVFpcE53b25GWlFCc2E1eEU4b1FJSVFYbndpanRCT2VBTTdkNHJBYjAy!2m2!1d39.95060866068454!2d-75.16559167955336!3f175.41629655592055!4f19.886483195564637!5f0.7820865974627469" 
        width="600" 
        height="450" 
...
<script>
        document.addEventListener('DOMContentLoaded', function() {
            var texts = ["WELCOME TO DINEHUB"]; // Array of texts to display
            var container = document.getElementById('container');

            // Function to display each text element with a delay
            function displayTexts(index) {
                if (index < texts.length) {
                    var textElement = document.createElement('p');
                    textElement.textContent = texts[index];
                    textElement.className = 'fade-in-out';
                    // Apply styles to the text
                    textElement.style.fontFamily = 'Times Roman';
                    textElement.style.fontSize = '6rem'; // Adjust the font size as needed
                    textElement.style.fontWeight = 'bold';
                    textElement.style.color = 'white'; // Set the color to black
  ...
  <section id="projects" style="background-color: #f4f4f4;">
    <div class="projects container">
      <div class="projects-header">
        ...
        <h1 class="section-title" style="text-align: center; font-family: 'Arial', sans-serif;">ME<span>N</span>U<span></h1>
...
<section id="about"  style="background-color: #f4f4f4;" >
  <div class="about container">
    <div class="col-right">
        ...
        <!-- <h1 class="section-title" style="text-align: center;">ABOUT <span>US<span></h1> -->
        <h1 class="section-title" style="text-align: center; font-family: 'Arial', sans-serif;">ABOUT <span>US</span></h1>

        <h2 style="text-align: center;">DINEHUB'S COMPANY HISTORY:</h2>

 <p>DineHub is a well-established Western food establishment in the city's heart. DineHub has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.
 </p>
 <p>DineHub, as a Western restaurant, offers a diverse menu that caters to a variety of tastes. The menu includes a wide range of options such as bar bites, salads, soups and a variety of main courses. Customers can savour succulent options such as steak and ribs, chicken, lamb, seafood, burgers and sandwiches, pasta, and a variety of delectable side dishes. The menu has been carefully curated to offer a balance of classic favourites and innovative creations, ensuring that every palate is satisfied.
 </p>
 <p>DineHub's ability to accommodate customers is one of its distinguishing features. DineHub strives to create an inviting and comfortable dining environment, whether guests prefer to walk in or make reservations in advance. The restaurant recognises the significance of creating memorable experiences, particularly for those celebrating special occasions. DineHub is a popular choice for families, couples, and groups of friends because of its attentive staff and welcoming atmosphere.
 </p>
 <p>DineHub has an inviting outdoor bar that is open seven days a week from 11:00 AM to 10:00 PM in addition to the indoor dining area.This outdoor space provides a relaxed setting for patrons to unwind and socialise while sipping on their favourite drinks and nibbling on bar bites. The bar serves a wide range of beverages, including cocktails, wines, beers and non-alcoholic options.
 </p>
...
<section id="contact"  style="background-color: #f4f4f4;">
  <div class="contact container">
    <div>
      <h1 class="section-title" style="text-align: center; font-family: 'Arial', sans-serif; color: #333; margin-bottom: 40px">CONTACT <span>INFO</span></h1>
    </div>
    <div class="contact-items">
      <div class="contact-item contact-item-bg" style="background-color: #fff; padding: 20px;">
        <div class="contact-info">
          <div class='icon'><img src="../image/icons8-phone-100.png" alt="Phone"/></div>
          <h2 style="font-family: 'Arial', sans-serif; color: #333;">Phone</h2>
          <p style="font-family: 'Arial', sans-serif; color: #666;">07899031393</p>
        </div>
      </div>
      ...
      <div class="contact-item contact-item-bg" style="background-color: #fff; padding: 20px;"> 
        <div class="contact-info">
          ...
          <h2 style="font-family: 'Arial', sans-serif; color: #333;">Email</h2>
          <p style="font-family: 'Arial', sans-serif; color: #666;">DineHub@gmail.com</p> 
        </div>
      </div>
      ...
      <div class="contact-item contact-item-bg" style="background-color: #fff; padding: 20px;">
        <div class="contact-info">
          ...
          <h2 style="font-family: 'Arial', sans-serif; color: #333;">Address</h2>
          <p style="font-family: 'Arial', sans-serif; color: #666;">Inside Green Park Hotel, 5th Floor, Eshwar Nagar, Karnataka 576104</p>
        </div>
      </div>
    </div>
  </div>
